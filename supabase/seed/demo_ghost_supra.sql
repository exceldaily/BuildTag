...
begin
  ...
  values (demo_user, 'buildtag_demo', 'Brad K.', 'Supra on four wheels, a Panigale and a Street Glide on two. Dyno days, track days, long rides and the occasional oil change.', 'Orlando, FL', 'https://example.com/buildtag-demo')
